...
<body>
    ...
    @include('layout-partials.category')
    ...
    @include('layout-partials.testimonial')
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-6 text-center" data-aos="fade">
                    ...
                    <p><a href="{{ route('register') }}" class="btn btn-outline-success py-3 px-4">Job Seekers</a> <a href="{{ route('employer.register') }}" class="btn btn-outline-warning py-3 px-4">Employer</a></p>
