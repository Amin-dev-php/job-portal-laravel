<div class="site-wrap">
    ...
    <div class="site-navbar-wrap js-site-navbar bg-white" id="navbar">
        <div class="container">
                            ...
                            <nav class="site-navigation text-right" role="navigation">
                                <div class="container">
                                    ...
                                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                                        @if(!Auth::user())
                                        <li><a href="{{ route('register') }}">Register Candidates</a></li>
                                        <li>
                                            <a href="{{ route('employer.register') }}">Register Employees</a>
                                        </li>
                                        @else
                                        <li>
